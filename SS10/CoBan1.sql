...
-- Câu 2: Tạo một view có tên view_users_firstname để hiển thị danh sách các người dùng có họ “Nguyễn”. 
-- View này cần bao gồm các cột: user_id, username, full_name, email, created_at.
...
-- Câu 3: Hiển thị lại view vừa tạo được.
SELECT * FROM view_users_firstname;

-- Câu 4: Thêm một nhân viên mới vào bảng User có họ “Nguyễn”.
-- Sau đó, truy vấn lại view view_users_firstname để kiểm tra xem nhân viên vừa thêm có xuất hiện trong view hay không.
INSERT INTO users(username, full_name, gender, email, password, birthdate, hometown) VALUES
('my', 'Nguyễn Thị My', 'Nữ', 'my@gmail.com', '123', '1990-02-01', 'Hà Nội');

SELECT * FROM view_users_firstname;

-- Câu 5: Thực hiện xóa nhân viên vừa thêm khỏi bảng User.
